...
theta = pi/6#火箭發射角度
direction = norm(vector(0,0,1/sin(latitude)*radius_of_earth)-rocket)#火箭發射方向
v = direction
...
while mag(rocket-center_of_earth)-radius_of_earth >= -0.2:
    rate(1000)
    m = mass(t)
    ...
    print(t,rocket,mag(rocket-center_of_earth)-radius_of_earth,dot(rocket,a))
    t += dt
# scene.center = rocket
